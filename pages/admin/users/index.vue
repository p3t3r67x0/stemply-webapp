  ...
  <div class="mx-3 lg:mx-0">
    ...
    <div class="flex justify-center bg-white rounded-lg">
      <table class="table table-fixed w-full text-md text-gray-800 rounded-lg">
        ...
        <tr v-for="(user, i) in users" :key="user._id" class="border-b even:bg-gray-100 odd:bg-white hover:bg-gray-400">
          <td data-label="Name" class="p-3 text-gray-700">
          ...
          <td data-label="Email" class="p-3 text-gray-700">
          ...
          <td data-label="Role" class="p-3 text-gray-700">
